...
//	private String vm = "172.17.152.122"; //dran
//	private String vm = "172.17.152.39";
//	private String vm = "172.17.152.28"; //mine
	private String vm = "localhost";
    ...
    public void testSingleSpecialtyPieOrder(){
    	...
    	PizzaClient client = null;
    	try {
	    	client = new PizzaClient(vm);
    ...
    public void testSliceOrder(){
		try {
			...
			assertEquals("Sales tax",0.26,response.getSalesTax(),0.001);
    ...
    public void testCombinedOrder(){
    	try {
    		...
    		assertEquals("Sales tax",2.49,response.getSalesTax(),0.001);
